...
#define cpu_map_h
  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    // Z Limit pin and spindle PWM/enable pin swapped to access hardware PWM on Pin 11.
        ...
        // If enabled, spindle direction pin now used as spindle enable, while PWM remains on D11. CNC shield z+ pin
  ...
  #define SPINDLE_DIRECTION_BIT   2   // Uno Digital Pin 10 (was digital pin 13 but swapped with ylimit for reverse spindle  http://pm.printech3d.co.uk:423/projects/printech/work_packages/77/activity)(NOTE: D13 can't be pulled-high input due to LED.)
    ...
    // Timer1 configuration for reverse PWM on D10 (SPINDLE_DIRECTION_BIT /  SPINDLE_)
    #define SPINDLE_TCCRA_DIR_REGISTER    TCCR1A
    #define SPINDLE_TCCRB_DIR_REGISTER    TCCR1B
    #define SPINDLE_OCR_DIR_REGISTER      OCR1B
    #define SPINDLE_COMB_DIR_BIT          COM1B1
